    ...
    <div className="designer-relationship-list">
      <div className="designer-section-header">
        ...
        <button
          ...
          title={entities.length < 1 ? t('designer.needEntityForRelationship') : t('designer.addRelationship')}
        >
              ...
              <div className="designer-rel-body">
                ...
                <label className="designer-field">
                  ...
                  <textarea
                    ...
                    placeholder={t('designer.relationshipDescriptionPlaceholder')}
                  />
                </label>
                  ...
                  {(rel.attributes ?? []).map((attr, idx) => (
                    <div key={idx} className="designer-property-row">
                      ...
                      <input
                        ...
                        placeholder={t('designer.attributeTypePlaceholder')}
                      />
                      <button
