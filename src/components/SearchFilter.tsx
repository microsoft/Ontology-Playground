        ...
        {isExpanded && (
          ...
          >
            ...
            <div style={{ display: 'flex', gap: 8, marginBottom: 10 }}>
              ...
              >
                {t('search.entitiesToggle', { count: currentOntology.entityTypes.length })}
              </button>
              <button
              ...
              >
                {t('search.relationshipsToggle', { count: currentOntology.relationships.length })}
              </button>
            </div>
                ...
                >
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    <div style={{ fontSize: 9, color: 'var(--text-secondary)' }}>
                      {t('search.propertiesCount', { count: entity.properties.length })}
                    </div>
                  </div>
                </motion.div>
              ))}
